...
lamb = @(x) (x(1)*Ae.Rr-sum(x(15:17)))/(vr(x));
...
Fyi = @(x,i) (0.5*Ae.rho*Ae.Ar*(vri(x,i))^3*cpi(x,i)/x(1))/(2*Ae.Rr/3);
...
% h = @(x) (x);
h = @(x) [x(1); f3(x); f5(x); B.l*B.m*f9(x); B.l*B.m*f10(x);...
    B.l*B.m*f11(x); B.l*B.m*f15(x); B.l*B.m*f16(x); B.l*B.m*f17(x);...
...
title("vr")
figure
plot(1:500,tr(1:500),1:500,xt(24,1:500))
title("Tr & Tg")
legend("Tr", "Tg")
figure
plot(1:500,p1(1:500),1:500,p2(1:500),1:500,p3(1:500))
title("ve1, ve2, ve3")
