function particles = ParticleFilterStateFcn4(particles,u,Ac,Ae,D,To,W,cp_l,ct_l,lambdaVec,pitchVec,v_m) 
...
for kk=1:numberOfParticles
    k_1 = StateFcnContinuous4(particles(:,kk),u(:,kk),Ac,Ae,D,To,W,cp_l,ct_l,lambdaVec,pitchVec,v_m);
    k_2 = StateFcnContinuous4(particles(:,kk)+0.5*Ts*k_1,u(:,kk)+0.5*Ts,Ac,Ae,D,To,W,cp_l,ct_l,lambdaVec,pitchVec,v_m);
    k_3 = StateFcnContinuous4(particles(:,kk)+0.5*Ts*k_2,u(:,kk)+0.5*Ts,Ac,Ae,D,To,W,cp_l,ct_l,lambdaVec,pitchVec,v_m);
    k_4 = StateFcnContinuous4(particles(:,kk)+Ts*k_3,u(:,kk)+Ts,Ac,Ae,D,To,W,cp_l,ct_l,lambdaVec,pitchVec,v_m);
