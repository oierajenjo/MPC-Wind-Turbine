function f = odeWindTurbine2Bladed(t,x,u,d,n,timeVector,Ac,Ae,B,D,To,cp_l,ct_l,lambdaVec,pitchVec,v_m)
% StateFcnContinuous Evaluate the system ODEs

% To obtain the value of the inputs at the specified time
for i=1:2
    u(i,:) = interp1(timeVector,u(i,:),t);
end
for i=1:10
    n(i,:) = interp1(timeVector,n(i,:),t);
end
for i=1:1
    d(i,:) = interp1(timeVector,d(i,:),t);
end
...
%% Wind
% f(13) = -w_p*x(13) + x(14)*pi/(2*W.L)*n(13); % Wind turbulence acceleration
% f(14) = n(14); % Mean wind acceleration
